...
int main(int argc, char *argv[]) {
  ...
  TestQuadSolve<backend::SIMD<8>>(a, b, c, x1, x2, roots, N, "portable simd::array<8> backend");
  TestQuadSolve<backend::SIMD<16>>(a, b, c, x1, x2, roots, N, "portable simd::array<16> backend");
  TestQuadSolve<backend::SIMD<24>>(a, b, c, x1, x2, roots, N, "portable simd::array<24> backend");
  TestQuadSolve<backend::SIMD<32>>(a, b, c, x1, x2, roots, N, "portable simd::array<32> backend");
