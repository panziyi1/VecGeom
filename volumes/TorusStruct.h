...
#ifndef VECGEOM_VOLUMES_TORUSSTRUCT_H_
#define VECGEOM_VOLUMES_TORUSSTRUCT_H_
...
struct TorusStruct {
  ...
  TorusStruct(const T rmin, const T rmax, const T rtor, const T sphi, const T dphi)
