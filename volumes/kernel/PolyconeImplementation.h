...
// VECGEOM_DEVICE_FORWARD_DECLARE(struct PolyconeImplementation;);
// VECGEOM_DEVICE_DECLARE_CONV(struct, PolyconeImplementation);
...
struct PolyconeImplementation {
  ...
  //  using UnplacedVolume_t = UnplacedPolycone;//<polyconeTypeT>;
