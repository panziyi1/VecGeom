...
VECCORE_ATT_HOST_DEVICE
VECGEOM_FORCE_INLINE
void GenTrapImplementation::ContainsGeneric(UnplacedStruct_t const &unplaced, Vector3D<Real_v> const &point, Bool_v &inside)
{
...
VECCORE_ATT_HOST_DEVICE
VECGEOM_FORCE_INLINE
void GenTrapImplementation::Contains<double, bool>(UnplacedStruct_t const &unplaced, Vector3D<double> const &point, bool &inside)
{
...
VECGEOM_FORCE_INLINE
VECCORE_ATT_HOST_DEVICE
void GenTrapImplementation::InsideGeneric(UnplacedStruct_t const &unplaced, Vector3D<Real_v> const &point, Inside_t &inside)
{
  // Generic implementation for Inside
  using Bool_v       = vecCore::Mask_v<Real_v>;
...
VECGEOM_FORCE_INLINE
VECCORE_ATT_HOST_DEVICE
void GenTrapImplementation::SafetyToInGeneric(UnplacedStruct_t const &unplaced, Vector3D<Real_v> const &point, Real_v &safety)
{
...
VECGEOM_FORCE_INLINE
VECCORE_ATT_HOST_DEVICE
void GenTrapImplementation::SafetyToIn(UnplacedStruct_t const &unplaced, Vector3D<double> const &point,
                                         double &safety)
{
...
template <typename Real_v>
VECCORE_ATT_HOST_DEVICE
void GenTrapImplementation::SafetyToOutGeneric(UnplacedStruct_t const &unplaced, Vector3D<Real_v> const &point, Real_v &safety)
{
...
VECGEOM_FORCE_INLINE
VECCORE_ATT_HOST_DEVICE
void GenTrapImplementation::SafetyToOut(UnplacedStruct_t const &unplaced, Vector3D<double> const &point,
                                          double &safety)
{
