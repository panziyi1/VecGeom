...
//#include "volumes/kernel/shapetypes/PolyconeTypes.h"
...
// template <typename polyconeTypeT = PolyconeTypes::UniversalPolycone>
// class UnplacedPolycone : public
// LoopUnplacedVolumeImplHelper<PolyconeImplementation<PolyconeTypes::UniversalPolycone>>, public AlignedBase { class
// UnplacedPolycone : public LoopUnplacedVolumeImplHelper<PolyconeImplementation<ConeTypes::UniversalCone>>, public
// AlignedBase {
...
public:
  ...
  /*
    ...
    VECCORE_ATT_DEVICE
    static VPlacedVolume *Create(LogicalVolume const *const logical_volume, Transformation3D const *const
  transformation, #ifdef VECCORE_CUDA const int id, #endif VPlacedVolume *const placement = NULL);
  */
...
class SUnplacedPolycone : public SIMDUnplacedVolumeImplHelper<PolyconeImplementation<PolyconeType>, UnplacedPolycone>,
                          public AlignedBase {
public:
  using BaseType_t = SIMDUnplacedVolumeImplHelper<PolyconeImplementation<PolyconeType>, UnplacedPolycone>;
