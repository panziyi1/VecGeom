...
class LayerNavigator : public VToyNavigatorHelper<LayerNavigator<Depth>> {
public:
    static VToyNavigator *Instance() {
...
template <int Depth=-1>
class InnerMostTubeNavigator : public VToyNavigatorHelper<InnerMostTubeNavigator<Depth>> {
